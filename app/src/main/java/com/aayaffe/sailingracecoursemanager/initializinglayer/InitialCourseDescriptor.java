...
public class InitialCourseDescriptor implements Serializable {
    ...
    private RaceCourseDescriptor GenerateTrapezoid60120() {
        ...
        Mark mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        ...
        start = new Mark("Start",0,new MarkLocation(0,0,true, LocationOptions.FROM_RACE_COMMITTEE),new GateConfiguration(GateType.START_LINE,GateOption.ALWAYS_GATED,-90,0.027,GateReference.RIGHT_MARK,true));
        mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        mk2 = new Mark("Mk2",2,new MarkLocation(-120,0.5,true,LocationOptions.FROM_MARK_ID,1));
        mk3 = new Mark("Mk3",3,new MarkLocation(-180,1,true,LocationOptions.FROM_MARK_ID,2),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        finish = new Mark("Finish",5,new MarkLocation(120,0.1,false,LocationOptions.FROM_MARK_ID,3),new GateConfiguration(GateType.FINISH_LINE,GateOption.ALWAYS_GATED,-90,0.032,GateReference.LEFT_MARK,false));
        ...
        mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        mk2 = new Mark("Mk2",2,new MarkLocation(-120,0.67,true,LocationOptions.FROM_MARK_ID,1));
        mk3 = new Mark("Mk3",3,new MarkLocation(-180,1,true,LocationOptions.FROM_MARK_ID,2),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        finish = new Mark("Finish",5,new MarkLocation(120,0.1,false,LocationOptions.FROM_MARK_ID,3),new GateConfiguration(GateType.FINISH_LINE,GateOption.ALWAYS_GATED,-90,0.032,GateReference.LEFT_MARK,false));        GeneralUtils.addAll(twoThirdsBeat.marks,start,mk4,mk1,mk2,mk3,finish);
    ...
    private RaceCourseDescriptor GenerateTrapezoid70110() {
        ...
        mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        mk2 = new Mark("Mk2",2,new MarkLocation(-110,0.5,true,LocationOptions.FROM_MARK_ID,1));
        mk3 = new Mark("Mk3",3,new MarkLocation(-180,1,true,LocationOptions.FROM_MARK_ID,2),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        finish = new Mark("Finish",5,new MarkLocation(110,0.1,false,LocationOptions.FROM_MARK_ID,3),new GateConfiguration(GateType.FINISH_LINE,GateOption.ALWAYS_GATED,-90,0.032,GateReference.LEFT_MARK,false));
        GeneralUtils.addAll(halfBeat.marks,start,mk4,mk1,mk2,mk3,finish);
        Inner2 = new MarkRoundingOrder("I2",0,4,1,4,1,2,3,5);
        Inner3 = new MarkRoundingOrder("I3",0,4,1,4,1,4,1,2,3,5);
        Inner4 = new MarkRoundingOrder("I4",0,4,1,4,1,4,1,4,1,2,3,5);
        ...
        mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        mk2 = new Mark("Mk2",2,new MarkLocation(-110,0.67,true,LocationOptions.FROM_MARK_ID,1));
        mk3 = new Mark("Mk3",3,new MarkLocation(-180,1,true,LocationOptions.FROM_MARK_ID,2),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        finish = new Mark("Finish",5,new MarkLocation(110,0.1,false,LocationOptions.FROM_MARK_ID,3),new GateConfiguration(GateType.FINISH_LINE,GateOption.ALWAYS_GATED,-90,0.032,GateReference.LEFT_MARK,false));
    ...
    private RaceCourseDescriptor GenerateWindWardLeeWard() {
        ...
        Mark startfinish = new Mark("Start",0,new MarkLocation(0,0,true, LocationOptions.FROM_RACE_COMMITTEE),new GateConfiguration(GateType.START_FINISH_LINE, GateOption.ALWAYS_GATED,-90,0.027, GateReference.RIGHT_MARK,true));
        Mark mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        Mark mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
    ...
    private RaceCourseDescriptor GenerateInnerOuterSlalom() {
        ...
        Mark mk4 = new Mark("Mk4",4,new MarkLocation(0,0.05,false, LocationOptions.FROM_MARK_ID,0),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        Mark mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,4),new GateConfiguration(GateType.SATELLITE,GateOption.GATABLE,125,0.08,GateReference.LEFT_MARK,false));
        Mark mk2 = new Mark("Mk2",2,new MarkLocation(-110,0.67,true,LocationOptions.FROM_MARK_ID,1));
        Mark mk3 = new Mark("Mk3",3,new MarkLocation(-180,0.5,true,LocationOptions.FROM_MARK_ID,2),new GateConfiguration(GateType.GATE,GateOption.GATABLE,-90,0.027,GateReference.GATE_CENTER,true));
        ...
        Mark finish = new Mark("Finish",8,new MarkLocation(265,1,true,LocationOptions.FROM_MARK_ID,7),new GateConfiguration(GateType.FINISH_LINE,GateOption.ALWAYS_GATED,-90,0.032,GateReference.GATE_CENTER,false));
    ...
    private RaceCourseDescriptor GenerateOptimist() {
        ...
        shortedOuter.name = "Shorted Outer";
        Mark start = new Mark("Start",0,new MarkLocation(0,0,true, LocationOptions.FROM_RACE_COMMITTEE),new GateConfiguration(GateType.START_LINE, GateOption.ALWAYS_GATED,-90,0.027, GateReference.RIGHT_MARK,true));
        Mark mk1 = new Mark("Mk1",1,new MarkLocation(0,1,true,LocationOptions.FROM_MARK_ID,0));
    ...
    private RaceCourseDescriptor GenerateTriangular() {
        ...
        Mark start = new Mark("StartFinish",0,new MarkLocation(0,0,true, LocationOptions.FROM_RACE_COMMITTEE),new GateConfiguration(GateType.START_FINISH_LINE, GateOption.ALWAYS_GATED,-90,0.027, GateReference.RIGHT_MARK,true));
